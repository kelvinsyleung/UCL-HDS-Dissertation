...
# Run the script
python /home/rmhisyl/Scratch/diss/src/train_patch_classifier.py --project_root /home/rmhisyl/Scratch/diss --color_space CIELAB --mag 20x
