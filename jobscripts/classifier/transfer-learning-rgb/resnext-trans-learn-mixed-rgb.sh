...
# Set name of job
#$ -N diss-mixed-rgb-resnext-trans-learn
...
# Run the script
python /home/rmhisyl/Scratch/diss/src/train_patch_classifier.py --project_root /home/rmhisyl/Scratch/diss --color_space RGB --mag mixed --transfer_learning True
